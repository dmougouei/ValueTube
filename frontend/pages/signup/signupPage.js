...
const SurveyPage = require("../../components/survey/survey.js")
...
module.exports = class SignUpPage {
    ...
    render() {
        ...
        const createAccount = new Button("Next", "", "primary", "");
        const surv = new SurveyPage();
        ...
        return `
            ...
            <html>
                <head>
                    ...
                    <link rel="icon" href="./frontend/img/ValueTube_Logogram.png>
                    ...
                    <div class="full-width-container">
                        <div class="content-container">
                            ...
                            <div class="form-separator">
                                ...
                                <input id="password-signup-input" class="input" type="text" placeholder="Password" name="password_signup" required/></br>
                            ...
                            </br><div>Already a member? <a href="./login">Sign In</a></div>
                        </div>
